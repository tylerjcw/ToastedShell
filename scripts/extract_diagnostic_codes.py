...
def emit_csharp(entries: dict[str, CodeEntry], repo_root: Path) -> str:
    """Emit a static C# manifest under `Tosh.Core.Generated.DiagnosticCodeManifest`."""
    out: list[str] = []
    ...
    out.append("")
    out.append("namespace Tosh.Core.Generated;")
    out.append("")
...
def main(argv: list[str]) -> int:
    ...
    parser.add_argument("--csharp", default=None,
                        help="Optional C# manifest output path (a static class with a code → metadata dictionary)")
