...
namespace Tosh.Core.Commands.Net;
...
[CommandOption("--as <response|json|text|bytes|lines>", "Choose how the response should be materialized.")]
...
[CommandOption("--bind <address>", "Bind `http serve` to a specific address.")]
...
[CommandOption("--index <file>", "Serve this index file for directories before directory listings.")]
