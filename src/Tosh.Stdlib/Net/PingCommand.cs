...
[CommandOption("-c, --count <count>", "Number of echo requests to send. Defaults to 4.", Default = "4")]
[CommandOption("-W, --timeout <milliseconds>", "Per-request timeout in milliseconds. Defaults to 4000.", Default = "4000")]
[CommandOption("-s, --size <bytes>", "Payload size in bytes. Defaults to 32.", Default = "32")]
[CommandOption("-i, --interval <seconds>", "Delay between requests, in seconds. Defaults to 1.", Default = "1")]
