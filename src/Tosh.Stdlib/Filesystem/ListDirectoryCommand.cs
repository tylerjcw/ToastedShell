...
[CommandOption("--sort <name|size|time>", "Choose the primary listing sort field.", Default = "name")]
[CommandOption("--time <modified|access|created>", "Choose which time field long listings and time sorts use.", Default = "modified")]
...
[CommandOption("-T <depth>", "Render entries as a tree (optional max depth).")]
[CommandOption("--tree", "Render entries as a tree.")]
...
[CommandOutput("Produces typed filesystem entries that the display layer renders as shell tables by default.", TypeName = "FileSystemEntry", Members = "Name, Type, Size, Modified, Permissions, Owner, Group", ClrType = typeof(IAsyncEnumerable<FileSystemEntry>))]
