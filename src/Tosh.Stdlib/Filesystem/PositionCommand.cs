...
[CommandOutput("Returns the current byte position for each supplied handle when that position can be reported safely.", ClrType = typeof(IAsyncEnumerable<long>))]
