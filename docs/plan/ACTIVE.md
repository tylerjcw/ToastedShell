...
| [`TOSH-0014`](items/TOSH-0014.md) | P1 | open | 0/3 | Programs started by TōSh inherit SIGPIPE as ignored, so a closed pipe is an error instead of an ending |
| [`TOSH-0015`](items/TOSH-0015.md) | P2 | open | 0/3 | 79 more standard-library files still read options from argument values |
