...
| [`TOAST-0125`](items/TOAST-0125.md) | P1 | in-progress | 2/12 | Generics audit: a null type-argument binding disables the checks it feeds, and only one constraint kind is enforced |
